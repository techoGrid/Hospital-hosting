...
@Component({
  selector: 'app-list-death-report',
  templateUrl: './list-death-report.component.html',
  styleUrls: ['./list-death-report.component.scss']
})
export class ListDeathReportComponent implements OnInit {
  ...
  addBirthReport() {
    this.router.navigate(['/deathReportHome/addDeathReport']);
  }
}
