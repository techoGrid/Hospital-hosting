...
@Component({
  selector: 'app-listbirth-report',
  templateUrl: './listbirth-report.component.html',
  styleUrls: ['./listbirth-report.component.scss']
})
export class ListbirthReportComponent implements OnInit {
  ...
  addBirthReport() {
    this.router.navigate(['/birthReportHome/addBirthReport']);
  }
