...
@Component({
  selector: 'app-addinternal-reference',
  templateUrl: './addinternal-reference.component.html',
  styleUrls: ['./addinternal-reference.component.scss']
})
export class AddinternalReferenceComponent implements OnInit {
