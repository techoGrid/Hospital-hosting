...
@Component({
  selector: 'app-listinternal-reference',
  templateUrl: './listinternal-reference.component.html',
  styleUrls: ['./listinternal-reference.component.scss']
})
export class ListinternalReferenceComponent implements OnInit {
