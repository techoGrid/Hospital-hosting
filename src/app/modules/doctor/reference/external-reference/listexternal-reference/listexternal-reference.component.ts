...
@Component({
  selector: 'app-listexternal-reference',
  templateUrl: './listexternal-reference.component.html',
  styleUrls: ['./listexternal-reference.component.scss']
})
export class ListexternalReferenceComponent implements OnInit {
  ...
  addReference() {
    this.router.navigate(['/externalReference/addExternalReference']);
  }
}
